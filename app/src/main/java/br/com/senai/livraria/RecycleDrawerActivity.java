...
public class RecycleDrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RecycleDrawerActivity.this, FormularioLivrosActivity.class);
    ...
    private void carregarListaRecycler() {
        ...
        List<Livro> livros = dao.buscaLivro();
        LivroRecicleAdapter adapter = new LivroRecicleAdapter(this, livros);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.recycle_drawer, menu);
        return true;
    }
